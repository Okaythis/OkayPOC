...
class HomeFragment : Fragment(), HomeContract.View {
    ...
    private val presenter: HomeContract.Actions by inject()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productAdapter.replaceProducts(presenter.loadProducts())
    }
    ...
    override fun openProductDetails() {
        // use transition to navigate to the next screen
    }
