...
class ProductListAdapter(private var products: ArrayList<Product>): RecyclerView.Adapter<ProductListAdapter.ProducListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProducListViewHolder {
        ...
        return ProducListViewHolder(LayoutInflater
            .from(parent.context)
